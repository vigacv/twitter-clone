        ...
        <>
            <div onClick={() => {
                ...
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex justify-around w-full mt-4" onClick={e => e.stopPropagation()}>
                        ...
                        <button
                            ...
                            onClick={toogleLike}
                            className="rounded-full flex items-center space-x-2 hover:bg-white/10 transition duration-200 cursor-pointer p-2"
                        >
